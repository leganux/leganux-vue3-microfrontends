    ...
    <div class="chat-list">
      <div class="chat-list-header">
        <div class="ui grid padded">
          ...
          <div class="row">
            <div class="column">
              <div class="ui fluid icon input search-box">
        ...
        >
          ...
          <div class="chat-item-content">
            <div class="chat-item-header">
              <div class="chat-item-name">{{ chat.name || formatPhoneNumber(chat.jid) }}</div>
              <div class="chat-item-time">{{ formatTimestamp(chat.lastMessageTimestamp) }}</div>
            </div>
            <div class="chat-item-message" v-if="chat.messages?.[0]">
              {{ chat.messages[0].content }}
            </div>
            <div v-if="chat.unreadCount" class="ui green circular label">
              {{ chat.unreadCount }}
            </div>
          </div>
        </div>
      ...
      <div v-if="selectedChat" class="h-100 d-flex flex-column">
        <div class="chat-header">
          <div class="ui grid middle aligned">
            <div class="left floated twelve wide column">
              <div class="ui grid middle aligned">
                ...
                <div class="fourteen wide column">
                  <div v-if="!isEditingName" class="chat-name">
                    {{ selectedChat.name || formatPhoneNumber(selectedChat.jid) }}
                  </div>
                  <div v-else class="ui small input">
                    <input
                      v-model="editedName"
                      type="text"
            ...
            <div class="right floated four wide column right aligned">
              <i class="pencil icon clickable" @click="startEditName"></i>
              <i class="ellipsis vertical icon clickable"></i>
            </div>
          </div>
        </div>
            ...
            <div class="message-bubble">
              ...
              <div v-if="message.file" class="media-content">
                ...
                <div v-if="message.type === 'audio' || message.content === 'Audio' || (message.file.mimeType && message.file.mimeType.startsWith('audio/'))">
                  <audio controls class="ui fluid audio">
              ...
              <div class="message-time">
                ...
                <i class="check double icon blue" v-if="message.from === 'me'"></i>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="message-input">
          <div class="ui fluid action input">
            ...
            />
            <button class="ui icon button" @click="openFileInput">
              <i class="paperclip icon"></i>
            </button>
            <button class="ui icon button" @click="sendTextMessage">
